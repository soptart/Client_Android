...
class MainActivity : AppCompatActivity() {
    ...
    private fun selectedMainTab(position: Int) {
        if (position == 0) {
            ...
            tv_bottom_navi_home_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_medium"))
            tv_bottom_navi_product_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
            tv_bottom_navi_exhibition_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
            tv_bottom_navi_my_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
        }
        else if (position == 1) {
            ...
            tv_bottom_navi_exhibition_tab.setTextColor(resources.getColor(R.color.colorMainNoSelect))
            tv_bottom_navi_my_tab.setTextColor(resources.getColor(R.color.colorMainNoSelect))
            tv_bottom_navi_home_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
            tv_bottom_navi_product_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_medium"))
            tv_bottom_navi_exhibition_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
            tv_bottom_navi_my_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
        }
        else if (position == 2) {
            ...
            tv_bottom_navi_home_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
            tv_bottom_navi_product_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
            tv_bottom_navi_exhibition_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_medium"))
            tv_bottom_navi_my_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
...
//            tv_bottom_navi_my_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            tv_bottom_navi_product_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
            tv_bottom_navi_exhibition_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_regular"))
            tv_bottom_navi_my_tab.setTypeface(Typeface.createFromAsset(assets, "fonts/notosanscjkkr_medium"))
//            tv_bottom_navi_home_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            tv_bottom_navi_product_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
