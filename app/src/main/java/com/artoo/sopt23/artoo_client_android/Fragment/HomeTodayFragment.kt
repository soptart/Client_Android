...
class HomeTodayFragment : Fragment() {
    ...
    private fun selectedArtistTab(position: Int) {
        if (position == 0) {
            ...
            txt_top_navi_first_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_bold"))
            txt_top_navi_second_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
...
//            txt_top_navi_fifth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            txt_top_navi_fourth_arti_tab.setTextColor(resources.getColor(R.color.colorNonSelectedTab))
            txt_top_navi_fifth_arti_tab.setTextColor(resources.getColor(R.color.colorNonSelectedTab))
            txt_top_navi_first_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_second_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_bold"))
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
...
//            txt_top_navi_fifth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            txt_top_navi_first_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_second_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_bold"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
//            txt_top_navi_first_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_second_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
...
//            txt_top_navi_fifth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            txt_top_navi_second_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_bold"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
//            txt_top_navi_first_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_second_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_third_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
...
//            txt_top_navi_fifth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_regular"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "fonts/notosansjkkr_bold"))
//            txt_top_navi_first_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_second_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_third_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_fourth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
