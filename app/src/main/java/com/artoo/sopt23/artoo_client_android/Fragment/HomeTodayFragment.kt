...
class HomeTodayFragment : Fragment() {
    ...
    private fun selectedArtistTab(position: Int) {
        if (position == 0) {
            ...
            txt_top_navi_first_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_bold.otf"))
            txt_top_navi_second_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
...
//            txt_top_navi_fifth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            txt_top_navi_fourth_arti_tab.setTextColor(resources.getColor(R.color.colorNonSelectedTab))
            txt_top_navi_fifth_arti_tab.setTextColor(resources.getColor(R.color.colorNonSelectedTab))
            txt_top_navi_first_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_second_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_bold.otf"))
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
...
//            txt_top_navi_fifth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            txt_top_navi_first_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_second_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_bold.otf"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
//            txt_top_navi_first_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_second_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
...
//            txt_top_navi_fifth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            txt_top_navi_second_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_bold.otf"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
//            txt_top_navi_first_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_second_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_third_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
...
//            txt_top_navi_fifth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
            ...
            txt_top_navi_third_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_fourth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_regular.otf"))
            txt_top_navi_fifth_arti_tab.setTypeface(Typeface.createFromAsset(ctx.assets, "font/notosansjkkr_bold.otf"))
//            txt_top_navi_first_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_second_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_third_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
//            txt_top_navi_fourth_arti_tab.setTypeface(resources.getFont(R.font.notosanscjkkr_regular))
